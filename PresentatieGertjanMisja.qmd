...
ggplot(df_pp, aes(x = grid, y = price_distribution, col = factor(run))) +
  geom_line() +
  labs(x = "price", y= "probability of the data") +
  ggtitle("verwachtte prijzen op basis van de gekozen priors voor een bedrijf met 30% marktaandeel \n en gemiddelde Complexiteit")
```
